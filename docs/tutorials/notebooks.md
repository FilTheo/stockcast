...
| [05e — Inventory processes](https://github.com/FilTheo/stockcast/blob/main/examples/notebooks/05e_inventory_processes.ipynb) | Start with ordinary shelf life, reproduce it with the process API, then add a Monday inspection and a dated return. Trace the stock balance, flow records, and lot dates at each step. |
